...
func (_m *ClusterNode) GetString(ctx context.Context, key string) (string, error) {
...
//   - ctx context.Context
//   - key string
func (_e *ClusterNode_Expecter) GetString(ctx interface{}, key interface{}) *ClusterNode_GetString_Call {
	return &ClusterNode_GetString_Call{Call: _e.mock.On("GetString", ctx, key)}
}

func (_c *ClusterNode_GetString_Call) Run(run func(ctx context.Context, key string)) *ClusterNode_GetString_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ClusterNode_GetString_Call) RunAndReturn(run func(context.Context, string) (string, error)) *ClusterNode_GetString_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetString provides a mock function with given fields: ctx, key, value
func (_m *ClusterNode) SetString(ctx context.Context, key string, value string) error {
...
//   - key string
//   - value string
func (_e *ClusterNode_Expecter) SetString(ctx interface{}, key interface{}, value interface{}) *ClusterNode_SetString_Call {
	return &ClusterNode_SetString_Call{Call: _e.mock.On("SetString", ctx, key, value)}
}

func (_c *ClusterNode_SetString_Call) Run(run func(ctx context.Context, key string, value string)) *ClusterNode_SetString_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ClusterNode_SetString_Call) RunAndReturn(run func(context.Context, string, string) error) *ClusterNode_SetString_Call {
	_c.Call.Return(run)
	return _c
}
